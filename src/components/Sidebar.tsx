...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            >
                {/* ── Navegación principal (altura fija) ── */}
                <div
                    className="rounded-xl p-4 flex flex-col gap-0.5 flex-shrink-0 transition-colors duration-300"
                    style={{ backgroundColor: 'var(--bg-sidebar-section)' }}
                >
                    {/* Logo */}
                ...
                {/* ── Biblioteca (flex-1 + min-h-0 para scroll interno correcto) ── */}
                <div
                    className="rounded-xl p-4 flex flex-col flex-1 min-h-0 transition-colors duration-300"
                    style={{ backgroundColor: 'var(--bg-sidebar-section)' }}
                >
                    {/* Cabecera fija */}
                    ...
                    {/* ── Zona scrollable: todo el contenido de la biblioteca ── */}
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar -mx-1 px-1">
                        <div className="space-y-2 pb-2">

                            {/* Crear playlist */}
                            <div
                                className="rounded-xl p-4 transition-all duration-300 hover:brightness-110 cursor-pointer"
                            ...
                            <Link
                                to="/misfavoritos"
                                onClick={() => sidebarOpen && toggleSidebar()}
                                className="rounded-xl p-3 transition-all duration-200 hover:brightness-110 cursor-pointer group/fav block"
                                style={{ backgroundColor: 'var(--bg-elevated)' }}
                            >
                            ...
                            {/* Separador */}
                            <div className="h-px mx-1" style={{ backgroundColor: 'var(--border-subtle)' }} />
                    ...
                    {/* Crédito fijo al fondo */}
                    <div className="mt-3 pt-3 flex-shrink-0" style={{ borderTop: '1px solid var(--border-subtle)' }}>
